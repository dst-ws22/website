...
It supports executable Python code blocks within markdown. This allows you to create fully reproducible documents, reports and [scientific articles](https://github.com/quarto-journals/).
